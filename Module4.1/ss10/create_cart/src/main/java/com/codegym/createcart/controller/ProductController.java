...
public class ProductController {
    ...
    public HashMap< Long, Cart > setSession(){
        System.out.println("Khởi tạo Session");
    ...
    @GetMapping("/list")
    public String showList(Model model, @ModelAttribute("carts") HashMap<Long,Cart> cart
            ) {
...
//        model.addAttribute("carts", cartHashMap);
    ...
    @GetMapping("/pay")
    public String showPay(Model model, @ModelAttribute("carts") HashMap<Long,Cart> cart
    ) {
        System.out.println(cart.size());
        Iterable<Product> products = productService.findAll();
        model.addAttribute("products", products);
...
//    @GetMapping("/mua")
//    public String showMua(Model model, @ModelAttribute("carts") HashMap<Long,Cart> cart
//    ) {
//        System.out.println(cart.size());
//        Iterable<Product> products = productService.findAll();
//        model.addAttribute("products", products);
...
//
//    @PostMapping("/mua")
//    public String muaProduct(@ModelAttribute Product product, @PathVariable Long id) {
//        productService.save(product);
