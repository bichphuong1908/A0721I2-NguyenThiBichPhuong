...
@EnableJpaRepositories(basePackages = "codegym.vn.repository")
...
//    }
    ...
    public DriverManagerDataSource getDataSource() {
        ...
        datasource.setUrl("jdbc:mysql://localhost:3306/blog?useSSL=false&useUnicode=true&characterEncoding=utf8&allowPublicKeyRetrieval=True");
        datasource.setUsername("root");
        datasource.setPassword("Gau082001");
        return datasource;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan(new String[]{"codegym.vn.model"});
