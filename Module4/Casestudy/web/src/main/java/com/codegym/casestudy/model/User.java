...
public class User implements Serializable {
    ...
    public User(Integer id, String fullName, String email, String address, String numberPhone, String imageAvatarOfUser, String password, String rememberToken, Timestamp createdAt, Timestamp updatedAt, Set<Role> roles) {
        this.id = id;
