package com.codegym.java_web.controller;

import com.codegym.java_web.model.*;
import com.codegym.java_web.service.RentTypeService;
import com.codegym.java_web.service.ServiceService;
import com.codegym.java_web.service.ServiceTypeService;
...
//        modelAndView.addObject("message", "customer updated successfully");
    ...
    public ModelAndView showDeleteForm(@PathVariable Long id , Model model) {
        ...
        model.addAttribute("serviceTypes", serviceTypes);
        if (service != null) {
            return new ModelAndView("service/delete","services",service);
    ...
    public String DeleteService(@ModelAttribute("services") Service service, RedirectAttributes redirectAttributes) {
